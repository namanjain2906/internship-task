...
const Content = () => {
  return (
    <section className="flex max-sm:flex-col h-screen justify-around items-center max-sm:gap-25">
      <div className="flex flex-col gap-10 max-sm:item-center">
        <div className="flex flex-col gap-2">
          <p className="font-semibold opacity-75 text-8xl max-sm:text-6xl">Earth's Exhale</p>
          <p className="font-medium text-xl opacity-75 w-140 max-sm:w-full max-sm:text-lg">
      ...
      <div className="bg-[url('/Frame.svg')] bg-center w-80 h-97.5 bg-cover bg-no-repeat backdrop-blur p-5 pb-10 flex flex-col gap-5 justify-end">
